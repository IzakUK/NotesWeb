...
export declare type BinaryOp = CompareOp | ArithmeticOp;
/** A (potentially computed) field to select or compare against. */
export declare type Field = BinaryOpField | VariableField | LiteralField | FunctionField | IndexField | NegatedField | LambdaField | ObjectField | ListField;
...
export declare namespace Fields {
    ...
    function literal(value: LiteralValue): LiteralField;
