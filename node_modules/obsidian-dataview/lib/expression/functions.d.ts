 ...
 */
export declare type FunctionImpl = (context: Context, ...rest: LiteralValue[]) => LiteralValue;
/** A "bound" function implementation which has already had a function context passed to it. */
export declare type BoundFunctionImpl = (...args: LiteralValue[]) => LiteralValue;
...
export declare class FunctionBuilder {
    ...
    add1<T extends LiteralTypeOrAll>(argType: T, impl: (a: LiteralReprAll<T>, context: Context) => LiteralValue): FunctionBuilder;
    /** Add a function variant which takes in two typed arguments. */
    add2<T extends LiteralTypeOrAll, U extends LiteralTypeOrAll>(arg1: T, arg2: U, impl: (a: LiteralReprAll<T>, b: LiteralReprAll<U>, context: Context) => LiteralValue): FunctionBuilder;
    /** Add a function variant which takes in three typed arguments. */
    add3<T extends LiteralTypeOrAll, U extends LiteralTypeOrAll, V extends LiteralTypeOrAll>(arg1: T, arg2: U, arg3: V, impl: (a: LiteralReprAll<T>, b: LiteralReprAll<U>, c: LiteralReprAll<V>, context: Context) => LiteralValue): FunctionBuilder;
