...
import { BinaryOpHandler } from "./binaryop";
import { Field } from "./field";
import { FunctionImpl } from "./functions";
...
export declare class Context {
    ...
    globals: Record<string, LiteralValue>;
     ...
     * and link handlers.
     */
    constructor(linkHandler: LinkHandler, settings: QuerySettings, globals?: Record<string, LiteralValue>, binaryOps?: BinaryOpHandler, functions?: Record<string, FunctionImpl>);
    /** Set a global value in this context. */
    set(name: string, value: LiteralValue): Context;
    /** Get the value of a global variable by name. Returns null if not present. */
    get(name: string): LiteralValue;
    /** Try to evaluate an arbitary field in this context, raising an exception on failure. */
    tryEvaluate(field: Field, data?: Record<string, LiteralValue>): LiteralValue;
    /** Evaluate an arbitrary field in this context. */
    evaluate(field: Field, data?: Record<string, LiteralValue>): Result<LiteralValue, string>;
}
