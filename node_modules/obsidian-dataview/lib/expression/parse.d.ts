...
import { BinaryOp, Field, LambdaField, ListField, LiteralField, ObjectField, VariableField } from "./field";
import { FolderSource, NegatedSource, Source, TagSource, CsvSource } from "data/source";
...
export declare function parseInnerLink(link: string): Link;
