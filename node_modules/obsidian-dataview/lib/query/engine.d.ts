...
import { Datarow } from "data/resolver";
import { DataObject, LiteralValue, Task, Grouping } from "data/value";
...
export declare type IdentifierMeaning = {
    type: "group";
    name: string;
...
export declare type Pagerow = Datarow<DataObject>;
...
export declare function executeInline(field: Field, origin: string, index: FullIndex, settings: QuerySettings): Result<LiteralValue, string>;
