...
export declare type QueryType = "list" | "table" | "task";
...
export declare type QueryHeader = ListQuery | TableQuery | TaskQuery;
...
export declare type QueryOperation = WhereStep | SortByStep | LimitStep | FlattenStep | GroupStep | ExtractStep;
/**
